...
public class Database {
    ...
    public static ArrayList<String> getStudentCoursesAndMarksForInstructor(String instructorUsername, String studentUsername) {
        initializeConnection();
        ArrayList<String> studentCoursesAndMarks = new ArrayList<>();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                float grade = resultSet.getFloat("grade");
                String courseInfo = courseName + " " + (grade != 0 ? grade : "N/A");
                studentCoursesAndMarks.add(courseInfo);
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }

        return studentCoursesAndMarks;
    }
    ...
    public static String getUserName(String username) {
        ...
        try {
            ...
            } else if ("instructor.jsp".equals(role)) {
    ...
    public static String getUserRole(String username) {
        ...
        try {
            ...
            String instructorSql = "SELECT 'instructor.jsp' AS role FROM instructors WHERE LOWER(username) = LOWER(?)";
